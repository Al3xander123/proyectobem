...
$(".principal").click(function(){
	$(".s_televisores,.s_equipos_de_sonido,.s_computadoras").fadeOut(time);
	$(".aiwa,.toshiba,.samsung,.sony,.pionner,.baja,.media,.alta").css("background-color","white");
...
$(".televisores").click(function(){
	...
	$(".aiwa,.toshiba,.samsung").css("background-color","white");
...
$(".equipos_de_sonido").click(function(){
	...
	$(".aiwa,.sony,.pionner").css("background-color","white");
...
$(".computadoras").click(function(){
	...
	$(".baja,.media,.alta").css("background-color","white");
